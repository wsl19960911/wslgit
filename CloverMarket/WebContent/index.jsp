...
<!--自定义模态窗口,登录与注册页-->
		<div class="modal-wrap">
			<div class="login-reg">
				...
				<!--注册操作-->
				<div class="reg">
					<input type="text" name="username" required="required" id="username" placeholder="请输入邮箱或手机号" />
					<input type="password" name="password" required="required" id="checkcode" placeholder="请输入密码" />
					<div class="protocol">
